...
export default function HealthDashboard() {
  ...
  // Sample data with different time ranges
  ...
  const getFilteredData = () => {
    const now = new Date('2023-11-20'); // Current date reference
  ...
  // Calculate dynamic trend analysis based on filtered data
  const calculateTrendAnalysis = (): TrendAnalysis => {
    ...
    // Extract triggers from filtered events
  ...
  // Generate chart data based on filtered events
  ...
  const doctorVisits: DoctorVisit[] = [
    {
      ...
      doctor: 'Dr. S. Patel',
      visitType: 'emergency',
      personalNotes: 'Very worried about the chest pain episode. Feel like my condition is getting worse.',
      doctorNotes: 'Patient presents with acute chest pain. ECG shows sinus tachycardia with occasional PVCs. Cardiac enzymes negative. Recommend stress test and 24-hour Holter monitor.',
      diagnosis: 'Suspected neuroinflammatory cardiac involvement',
      treatment: ['Increased beta-blocker dosage', 'Stress test ordered', 'Holter monitor scheduled'],
      medicationsChanged: true,
      cardiacEventsDuringVisit: 1
    }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6 lg:col-span-2">
            ...
            {/* Cardiac Events Timeline - New Feature */}
            <div className="bg-white rounded-xl shadow-sm p-6">
          ...
          {/* Right Column - Original Content + New Features */}
          <div className="space-y-6">
            ...
            {/* AI Recommendations - New Feature */}
